  ...
  return (
    <group {...props} dispose={null}>
      ...
      <group position={[-10.023, 0.812, 11.499]} scale={[2.61, 1.996, 2.61]}>
        <mesh geometry={nodes.Icosphere003.geometry} material={materials.Rock} />
        <mesh geometry={nodes.Icosphere003_1.geometry} material={materials.Water} />
      </group>
      <group position={[10.881, 3.522, -8.62]} scale={2.558}>
        <mesh geometry={nodes.Icosphere004.geometry} material={materials.Rock} />
        <mesh geometry={nodes.Icosphere004_1.geometry} material={materials.Soil} />
      </group>
      <mesh
        ...
        rotation={[0, -1.136, 0]}
      />
      <group position={[0.245, 12.341, 1.352]} rotation={[0, -1.136, 0]} scale={1.554}>
        <mesh
          name="Icosphere001"
